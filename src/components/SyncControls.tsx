...
import { setRootDocUrl } from "../utils/rootDoc";
...
export const SyncControls: React.FC<SyncControlsProps> = ({ docUrl }) => {
  ...
  return (
    <div className="flex gap-1">
      <button className="p-5 bg-cyan-500" onClick={handleExport}>
        Copy account token
      </button>
      <button className="p-5 bg-cyan-500" onClick={() => setShowImportDialog(true)}>
